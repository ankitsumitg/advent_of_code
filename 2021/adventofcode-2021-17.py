...
# and the next point we will hit will be at -initial_vy - 1.
# this vy should be equal to our lower bound of y, including sign equivalence
# -initial_vy - 1 == -y1, initial_vy = (1 + y1)
